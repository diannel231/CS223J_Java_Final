...
public class Game extends JFrame implements KeyListener, ActionListener{
	...
	ImageIcon fastDog = new ImageIcon("src/images/fastDog.gif");
	...
	ImageIcon closeDog = new ImageIcon("src/images/closeUpDog.PNG");
	
	ImageIcon dog = new ImageIcon("src/images/AnnoyingDog.gif");
	ImageIcon overDummy = new ImageIcon("src/images/Dummy.png");
	ImageIcon artifact = new ImageIcon("src/images/Artifact.png");
